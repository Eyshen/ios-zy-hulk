...
@implementation ZMZAPMSimplePing
...
static void SocketReadCallback(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void *data, void *info) {
    ...
    ZMZAPMSimplePing *    obj;
    
    obj = (__bridge ZMZAPMSimplePing *) info;
    assert([obj isKindOfClass:[ZMZAPMSimplePing class]]);
