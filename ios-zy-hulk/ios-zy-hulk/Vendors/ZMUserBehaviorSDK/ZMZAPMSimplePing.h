...
@interface ZMZAPMSimplePing : NSObject
...
- (void)simplePing:(ZMZAPMSimplePing *)pinger didStartWithAddress:(NSData *)address;
...
- (void)simplePing:(ZMZAPMSimplePing *)pinger didFailToSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
